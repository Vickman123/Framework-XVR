 ...
 */
export class QuestPWATarget implements BuildTarget {
  public readonly name = 'quest-pwa';
  public readonly description = 'Meta Horizon Store PWA package (Future target / Architectural placeholder)';

  public async build(_options: BuildOptions): Promise<BuildResult> {
    console.warn(`
